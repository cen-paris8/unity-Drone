...
public class DroneAlone : MonoBehaviour
{
    public TeamAlone Team => _team;
    [SerializeField] private TeamAlone _team;
    ...
    private DroneStateAlone _currentState;
            ...
            case DroneStateAlone.Wander:
                {
                    ...
                    if (targetToAggro != null)
                    {
                        ...
                        _currentState = DroneStateAlone.Chase;
                    }
                    break;
                }
            case DroneStateAlone.Chase:
                {
                    if (_target == null)
                    {
                        _currentState = DroneStateAlone.Wander;
                        return;
                    }
                    ...
                    {
                        _currentState = DroneStateAlone.Attack;
                    }
                    break;
                }
            case DroneStateAlone.Attack:
                {
                    if (_target != null)
                    {
...
public enum TeamAlone
{
    Red,
    Blue
}

public enum DroneStateAlone
{
    Wander,
    Chase,
    Attack
